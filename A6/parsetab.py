...
_lr_productions = [
  ...
  ('program -> stmt_list','program',1,'p_program','static_interpreterext.py',130),
  ('stmt_list -> stmt SEMICOLON stmt_list','stmt_list',3,'p_stmt_list','static_interpreterext.py',138),
  ('stmt_list -> stmt','stmt_list',1,'p_stmt_list','static_interpreterext.py',139),
  ('stmt -> assign_stmt','stmt',1,'p_stmt','static_interpreterext.py',148),
  ('stmt -> while_stmt','stmt',1,'p_stmt','static_interpreterext.py',149),
  ('stmt -> if_stmt','stmt',1,'p_stmt','static_interpreterext.py',150),
  ('expr -> expr PLUS term','expr',3,'p_add','static_interpreterext.py',154),
  ('expr -> expr MINUS term','expr',3,'p_sub','static_interpreterext.py',158),
  ('expr_list -> expr COMMA expr_list','expr_list',3,'p_expr_list','static_interpreterext.py',162),
  ('expr_list -> expr','expr_list',1,'p_expr_list','static_interpreterext.py',163),
  ('expr -> term','expr',1,'p_expr_term','static_interpreterext.py',171),
  ('term -> term TIMES fact','term',3,'p_mult','static_interpreterext.py',175),
  ('term -> term CONCAT fact','term',3,'p_term_CONCAT','static_interpreterext.py',179),
  ('term -> fact','term',1,'p_term_fact','static_interpreterext.py',183),
  ('fact -> LPAREN expr RPAREN','fact',3,'p_fact_expr','static_interpreterext.py',187),
  ('fact -> NUMBER','fact',1,'p_fact_NUM','static_interpreterext.py',191),
  ('fact -> IDENT','fact',1,'p_fact_IDENT','static_interpreterext.py',195),
  ('fact -> list','fact',1,'p_fact_list','static_interpreterext.py',199),
  ('fact -> func_call','fact',1,'p_fact_funcall','static_interpreterext.py',203),
  ('fact -> proc','fact',1,'p_fact_proc','static_interpreterext.py',207),
  ('assign_stmt -> IDENT ASSIGNOP expr','assign_stmt',3,'p_assn','static_interpreterext.py',211),
  ('while_stmt -> WHILE expr DO stmt_list OD','while_stmt',5,'p_while','static_interpreterext.py',215),
  ('if_stmt -> IF expr THEN stmt_list ELSE stmt_list FI','if_stmt',7,'p_if','static_interpreterext.py',219),
  ('proc -> PROC LPAREN param_list RPAREN stmt_list END','proc',6,'p_proc','static_interpreterext.py',223),
  ('proc -> PROC LPAREN RPAREN stmt_list END','proc',5,'p_proc','static_interpreterext.py',224),
  ('param_list -> IDENT COMMA param_list','param_list',3,'p_param_list','static_interpreterext.py',231),
  ('param_list -> IDENT','param_list',1,'p_param_list','static_interpreterext.py',232),
  ('list -> LBRACKET sequence RBRACKET','list',3,'p_list','static_interpreterext.py',240),
  ('list -> LBRACKET RBRACKET','list',2,'p_list','static_interpreterext.py',241),
  ('sequence -> listelement COMMA sequence','sequence',3,'p_sequence','static_interpreterext.py',248),
  ('sequence -> listelement','sequence',1,'p_sequence','static_interpreterext.py',249),
  ('listelement -> list','listelement',1,'p_listelement','static_interpreterext.py',283),
  ('listelement -> NUMBER','listelement',1,'p_listelement','static_interpreterext.py',284),
  ('func_call -> IDENT LPAREN expr_list RPAREN','func_call',4,'p_func_call','static_interpreterext.py',288),
]
