...
def compile(P, verbose=False, optimize=False, trans=False, link=False, op=False):
	...
	print 'Linking Code..'
	linked= linker.linker(peepholeCode, P.getMemory())
	if verbose or link:
		print 'Linked code:'
		print linked
		if link: return 
...
compiled = compile(parsed, a.verbose, a.Optimize, a.trans, a.link, a.op)
